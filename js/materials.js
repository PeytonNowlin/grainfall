...
(function (root) {
  ...
  var COLORS = new Uint8Array([
    ...
    /* SEED      */ 140, 180, 60, 255,
    /* GAS       */ 96, 112, 96, 255,
    /* GLASS     */ 190, 210, 220, 255,
    /* MERCURY   */ 200, 205, 215, 255,
    /* CLONE     */ 184, 184, 48, 255,
    /* TORCH     */ 200, 110, 40, 255,
    /* NITRO     */ 150, 180, 80, 255,
    /* VIRUS     */ 200, 60, 200, 255,
    /* FAN       */ 90, 140, 190, 255,
    /* ANT       */ 205, 120, 70, 255,
    /* BIRD      */ 80, 220, 220, 255,
    /* FIGHTER   */ 255, 105, 180, 255,
    /* METAL     */ 150, 156, 168, 255,
    /* THUNDER   */ 235, 245, 255, 255,
  ]);
  ...
  var PALETTE = [
    ...
    { id: MAT.OIL, name: "Oil", color: "#60482c", tool: false },
    { id: MAT.PLANT, name: "Plant", color: "#34a848", tool: false },
    { id: MAT.FIRE, name: "Fire", color: "#ff7820", tool: false },
    { id: MAT.LAVA, name: "Lava", color: "#ff4818", tool: false },
    { id: MAT.NAPALM, name: "Napalm", color: "#ff3030", tool: false },
    { id: MAT.STEAM, name: "Steam", color: "#b4bed2", tool: false },
    { id: MAT.GUNPOWDER, name: "Gunpowder", color: "#46464a", tool: false },
    { id: MAT.NITRO, name: "Nitro", color: "#96b450", tool: false },
    { id: MAT.GAS, name: "Gas", color: "#607060", tool: false },
    ...
    { id: MAT.SEED, name: "Seed", color: "#8cb43c", tool: false },
    { id: MAT.GLASS, name: "Glass", color: "#bed2dc", tool: false },
    { id: MAT.MERCURY, name: "Mercury", color: "#c8cdd7", tool: false },
    ...
    { id: MAT.ANT, name: "Ant", color: "#cd7846", tool: false },
    { id: MAT.BIRD, name: "Bird", color: "#50dcdc", tool: false },
    { id: MAT.FIGHTER, name: "Fighter", color: "#ff69b4", tool: false },
    { id: MAT.METAL, name: "Metal", color: "#969ca8", tool: false },
    { id: MAT.THUNDER, name: "Thunder", color: "#ebf5ff", tool: false },
